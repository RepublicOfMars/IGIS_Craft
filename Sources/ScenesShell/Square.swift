...
class Square {
    var center : Point3d
    var axis : String //face of square is along this axis (x, y, z)
    var size : Double
    ...
    func renderSquare(camera:Camera, canvas:Canvas, color:Color) {
        self.getPath().renderPath(camera:camera, canvas:canvas, color:color)
    }
}
