...
swift run -Xswiftc -I -Xswiftc $IGIS_LIBRARY_PATH -Xswiftc -L -Xswiftc $IGIS_LIBRARY_PATH -Xswiftc -I -Xswiftc $SCENES_LIBRARY_PATH -Xswiftc -L -Xswiftc $SCENES_LIBRARY_PATH -Xswiftc -lIgis -Xswiftc -lScenes
